...
class IronGolemMixinTest {
    ...
    void healAmountUsesZombieRottenFleshConfig() {
        ...
        assertEquals(40.0F, IronGolemMixin.healAmount(GolemVariant.ZOMBIE, zombie), 0.0001F);
    }
    ...
    void healAmountDefaultsOtherVariantsToTwentyFive() {
        ...
        assertEquals(25.0F, IronGolemMixin.healAmount(GolemVariant.GOLD, gold), 0.0001F);
    }
}
